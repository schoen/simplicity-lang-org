...
???+ "Your choice"
    After the introduction below, you'll choose your most familiar language environment (Rust or `bash`/CLI) below. You can also run any version [online, with no download](https://github.com/Blockstream/simplicity-codespace/).
